...
namespace TradeProcessorRefactoring
{
  public  class TradeProcessor
    {
        ...
        private List<TradeRecord> ParseTrades(IEnumerable<string> tradeData)
        {
            ...
            foreach (var line in tradeData)
            {
                ...
                var trade = MapTradeDataToTradeRecords(fields);
                trades.Add(trade);
                lineCount++;
        ...
        private TradeRecord MapTradeDataToTradeRecords(string[] fields)
        {
        ...
        private bool ValidateTradeData(string[] fields, int currentLine)
        {
            ...
            {
                LogMessage("Warn: Trade currencied on line{0} malformed: '{1}'", currentLine, fields[0]);
                return false;
             }
            int tradeAmount;
